...
#
# Description:
#    Integration test for the canonical Particle Swarm Optimization.
#
###############################################################################
...
cat("\n")
cat("=============================================\n")
cat("PARTICLE SWARM OPTIMIZATION TEST\n")
cat("=============================================\n\n")
...
for(ind in result$individuals){
  ...
  stopifnot(is.finite(ind$pbestFitness))
...
cat("\n")
cat("=============================================\n")
cat("PARTICLE SWARM OPTIMIZATION TEST PASSED!\n")
cat("=============================================\n")